...
uplink-magazine-akms-name = AKMS magazine (.30 rifle)
uplink-magazine-akms-desc = Rifle magazine with 25 catridges. Compatible with the AKMS.
...
uplink-magazine-ap-bulldog-name = .50 Flechette Shotgun Drum
uplink-magazine-ap-bulldog-desc = Shotgun drum with 8 .50 Flechette Shells, that pierce armor. Compatible with the Bulldog.

uplink-magazine-incend-bulldog-name = .50 incendiary Shotgun Drum
uplink-magazine-incend-bulldog-desc = Shotgun drum with 8 .50 incendiary Shells. Compatible with the Bulldog.
